...
class WPScan(ServiceScan):
	...
	def configure(self):
		self.add_option('api-token', help='Токен API от wpvulndb.com для помощи в поиске дополнительных уязвимостей.')
